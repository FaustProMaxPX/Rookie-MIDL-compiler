...
public class MIDLGrammarParser extends Parser {
	...
	public static final int
		...
		UNDERLINE=32, INTEGER_TYPE_SUFFIX=33, SHIFT_OP=34, ADD_OP=35, MULT_OP=36, 
		UNARY_OP=37, INTEGER=38, EXPONENT=39, FLOAT_TYPE_SUFFIX=40, FLOATING_PT=41, 
		ESCAPE_SEQUENCE=42, CHAR=43, STRING=44, ID=45, LETTER=46, DIGIT=47, WS=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, "BOOLEAN", "UNDERLINE", "INTEGER_TYPE_SUFFIX", 
			"SHIFT_OP", "ADD_OP", "MULT_OP", "UNARY_OP", "INTEGER", "EXPONENT", "FLOAT_TYPE_SUFFIX", 
			"FLOATING_PT", "ESCAPE_SEQUENCE", "CHAR", "STRING", "ID", "LETTER", "DIGIT", 
			"WS"
		};
	}
	...
	public final Member_listContext member_list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 35184388866016L) != 0)) {
				{
				{
				setState(86);
				type_spec();
	...
	public static class Unary_exprContext extends ParserRuleContext {
		...
		public TerminalNode UNARY_OP() { return getToken(MIDLGrammarParser.UNARY_OP, 0); }
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(242);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 28864327712768L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
